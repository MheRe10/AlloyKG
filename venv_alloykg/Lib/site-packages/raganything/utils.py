...
async def insert_text_content(
    ...
    """
    print(f"Starting text content insertion into LightRAG...of file:{file_paths}")
    print(dir(lightrag.full_docs))
    print("input:", repr(input)[:200])
    print("ids:", ids)
    ...
    print("Text content insertion complete")
