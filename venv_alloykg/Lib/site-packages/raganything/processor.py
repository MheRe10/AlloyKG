...
class ProcessorMixin:
    ...
    def _generate_content_based_doc_id(self, content_list: List[Dict[str, Any]]) -> str:
        ...
        print(f"Generated content-based doc_id...:{doc_id}")
        return doc_id
    ...
    async def _store_chunks_to_lightrag_storage_type_aware(
        ...
        print("storing chunks to lightrag storage...")
        try:
    ...
    async def process_document_complete(
        ...
        **kwargs,
        ...
        print("(1)finished parsing document, content_list 长度：", len(content_list))

        # Use provided doc_id or fall back to content-based doc_id
        if doc_id is None:
            doc_id = content_based_doc_id

        print(f"Generated/Using doc_id: {doc_id}")
        # Step 2: Separate text and multimodal content
        text_content, multimodal_items = separate_content(content_list)
        print(f"(2)separated text and multimodal content, text_content 长度：{len(text_content)}, multimodal_items 长度：{len(multimodal_items)}")
        ...
        print("(2.5)set content source for context-aware multimodal processing")
        ...
        print(f"(3)inserted text content for document: {file_path}")
        ...
        print(f"(4)processed multimodal content，长度：{len(multimodal_items)}")
        print(f"YEAAAAAA!!! Finished processing document: {file_path}")
    ...
    async def insert_content_list(
        ...
        print(f"start inserting content list: {doc_id if doc_id else file_path}")
        """
        ...
        print(f"Finished inserting content list for: {file_path}")
